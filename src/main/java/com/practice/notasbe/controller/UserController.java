...
public class UserController {
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<User> buscarPorId(@PathVariable Integer userId) throws ItemNotFoundException {
    ...
    public ResponseEntity<HttpResponse> createAlumno(@RequestBody UserDTO userDTO) throws ItemAlreadyInUseException {
        ...
        return new ResponseEntity<>(new HttpResponse(HttpStatus.CREATED.value(), HttpStatus.CREATED, HttpStatus.CREATED.getReasonPhrase(), "User created successfully"),
                HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<HttpResponse> updateAlumno(@PathVariable Integer userId, @RequestBody UserDTO userDTO) throws ItemNotFoundException {
        ...
        return new ResponseEntity<>(
                new HttpResponse(HttpStatus.OK.value(), HttpStatus.OK, HttpStatus.OK.getReasonPhrase(), "User updated successfully"),
                HttpStatus.OK
        );
    }
    ...
    public ResponseEntity<HttpResponse> deleteClient(@PathVariable Integer userId) throws ItemNotFoundException{
        ...
        return new ResponseEntity<>(
                new HttpResponse(HttpStatus.OK.value(), HttpStatus.OK, HttpStatus.OK.getReasonPhrase(), "User deleted successfully"),
                HttpStatus.OK
        );
    }
